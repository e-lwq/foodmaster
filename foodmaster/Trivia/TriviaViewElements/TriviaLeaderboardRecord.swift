...
struct TriviaLeaderboardRecord: View {
    let rank: String
    let name: String
    let xp: Int
    let ind: Int
    ...
    var body: some View {
        ZStack{
            Rectangle()
                ...
                .cornerRadius(10)
                .foregroundColor(Color.init(red: 0.96, green: 0.76, blue: 0.36))
...
struct TriviaLeaderboardRecord_Previews: PreviewProvider {
    static var previews: some View {
        TriviaLeaderboardRecord(rank: "Beginner", name: "abc", xp: 100, ind: 4)
    }
}
